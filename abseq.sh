...
READS_R1=/data/IgSeqBX1_S1_R1_001.fastq
READS_R2=/data/IgSeqBX1_S1_R2_001.fastq
R1_PRIMERS=/data/primers_R1.fasta
R2_PRIMERS=/data/primers_R2_reverse_complement.fasta
BARCODE_LENGTH=8
SAMPLE_NAME=IgSeqBX1
OUT_DIR=/data/presto-output_krista_primers_barcode8_R2_reverse_full_dataset
NPROC=16
